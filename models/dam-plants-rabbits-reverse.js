  ...
  window.model = {
    ...
    setupCharts: function() {
      ...
      updateCharts = function() {
        var agent, i, plantCounts, rabbitCounts, _i, _j, _len, _ref;
        rabbitCounts = {
          top: [0, 0, 0, 0],
          bottom: [0, 0, 0, 0]
        };
        ...
        for (i = _j = 0; _j <= 2; i = ++_j) {
          _this.chartData1.setValue(i, 1, rabbitCounts.top[i + 1]);
          _this.chartData1.setValue(i, 3, Math.floor(plantCounts.top[i + 1] * 1.5));
          _this.chartData2.setValue(i, 1, rabbitCounts.bottom[i + 1]);
          _this.chartData2.setValue(i, 3, Math.floor(plantCounts.bottom[i + 1] * 1.5));
        }
    ...
    _setupChartData: function(chartData) {
      ...
      return chartData.addRows([["Small", 0, "color: #b77738", 0, "color: #00FF00"], ["Medium", 0, "color: #6b5021", 0, "color: #00CC00"], ["Big", 0, "color: #4c190a", 0, "color: #008800"]]);
    },
    ...
    setupControls: function() {
      ...
      removeDamButton.onclick = function() {
        if (!_this.damRemoved) {
    ...
    setupTimer: function() {
      ...
      waterLevelIndicator.style.height = "9%";
      ...
      return Events.addEventListener(Environment.EVENTS.RESET, function() {
        ...
        return waterLevelIndicator.style.height = "9%";
      });
    },
  ...
  window.onload = function() {
    return helpers.preload([model, env, rabbitSpecies, plantSpecies], function() {
      ...
      if (iframePhone) {
        ...
        phone.initialize();
        metadata = {
          model: "Dam Plants-Rabbits Reverse"
        };
