...
(function() {
  ...
  window.model = {
    ...
    setupDialogs: function() {
      ...
      Events.addEventListener(Environment.EVENTS.SEASON_CHANGED, function() {
      ...
      setLocation = function(parent, child) {
      ...
      allAgentsAreHealthy = function(agents) {
